...
// +kubebuilder:validation:Enum=robotGpu;robotCpu
type RobotType string

const (
	GPURobot RobotType = "robotGpu"
	CPURobot RobotType = "robotCpu"
)
...
type RobotSpec struct {
	...
	// Foo is an example field of Robot. Edit robot_types.go to remove/update
	Foo             string             `json:"foo,omitempty"`
	Type            string             `json:"type,omitempty"`
	Engin           string             `json:"engin,omitempty"`
	RobotType       RobotType          `json:"robotType,omitempty"`
